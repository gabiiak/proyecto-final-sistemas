...
namespace Login
{
    public partial class UITandasManagement : Form
    {
        ...
        private void UITandasManagement_Load(object sender, EventArgs e)
        {
            labelId.Text = "";
        ...
        {
            UIRegisterTanda registrar = new UIRegisterTanda();
        ...
        private void btnCambiarEstado_Click(object sender, EventArgs e)
        {
            ...
            UITandaState estadoForm = new UITandaState();
