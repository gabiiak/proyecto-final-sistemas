...
namespace Login
{
    public partial class UIRegisterTanda : Form
    {
        ...
        public UIRegisterTanda()
        {
            InitializeComponent();
            dgvTanda_Detalles.AllowUserToAddRows = false;
        }

        private void UIRegisterTanda_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            UIRegisterTandaDetail regDetalle = new UIRegisterTandaDetail();
